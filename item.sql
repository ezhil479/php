...
CREATE INDEX description_fulltext_search
  ON core_item_information
  USING gist
  (description_text_search_vector );

CREATE INDEX keywords_fulltext_search
  ON core_item_information
  USING gist
...
ALTER TABLE ONLY core_item_class_has_item_information ADD CONSTRAINT core_item_class_has_item_information_item_class_id_fkey FOREIGN KEY (item_class_id)
      REFERENCES core_item_classes (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE

ALTER TABLE ONLY core_item_class_has_item_information ADD CONSTRAINT core_item_class_has_item_information_item_information_id_fkey FOREIGN KEY (item_information_id)
      REFERENCES core_item_information (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE

ALTER TABLE ONLY core_item_concretion ADD CONSTRAINT core_item_concretion_include_id_fkey FOREIGN KEY (include_id)
      REFERENCES core_base_includes (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE

ALTER TABLE ONLY core_item_has_item_classes ADD CONSTRAINT core_item_has_item_classes_item_class_id_fkey FOREIGN KEY (item_class_id)
      REFERENCES core_item_classes (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE

ALTER TABLE ONLY core_item_has_item_classes ADD CONSTRAINT core_item_has_item_classes_item_id_fkey FOREIGN KEY (item_id)
      REFERENCES core_items (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE

ALTER TABLE ONLY core_item_has_item_information ADD CONSTRAINT core_item_has_item_information_item_id_fkey FOREIGN KEY (item_id)
      REFERENCES core_items (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE

ALTER TABLE ONLY core_item_has_item_information ADD CONSTRAINT core_item_has_item_information_item_information_id_fkey FOREIGN KEY (item_information_id)
      REFERENCES core_item_information (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION DEFERRABLE INITIALLY IMMEDIATE

ALTER TABLE ONLY core_item_holders ADD CONSTRAINT core_item_holders_include_id_fkey FOREIGN KEY (include_id)
      REFERENCES core_base_includes (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE

ALTER TABLE ONLY core_item_information ADD CONSTRAINT core_item_information_language_id_fkey FOREIGN KEY (language_id)
